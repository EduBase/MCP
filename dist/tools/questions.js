...
export const EDUBASE_API_TOOLS_QUESTIONS = [
    ...
    // POST /question - Publish or update a question
    {
        ...
        inputSchema: z.object({
            ...
            rubric_criteria: z.string().describe('Rubric criteria and score in percentage for manual or semi-automatic scoring. Format: {criterion; points}. Applicable for FILE and FREE-TEXT questions, or after enabling manual_scoring.'),
