    ...
    // POST /question - Publish or update a question
    {
        ...
        inputSchema: {
            ...
            properties: {
                ...
                file_count: {
                    type: 'string',
                    description: "Limit the number of files that can be uploaded.\n" +
                ...
                file_types: {
                    type: 'string',
                    description: "Limit the filetypes that can be uploaded.\n" +
                        "- Applicable only for FILE questions\n" +
                ...
                hotspot_image: {
                    type: 'string',
                    description: "The image on which the points must be marked.\n" +
                        "Supported formats: PNG, JPEG, WebP\n" +
                        "Format: filename=data, where data is either a base64-encoded image (whole data string) or a URL"
                },
                hotspot_zones: {
                    type: 'string',
                    description: "Zones accepted as answers.\n" +
