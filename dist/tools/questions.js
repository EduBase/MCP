...
export const EDUBASE_API_TOOLS_QUESTIONS = [
    ...
    // POST /question - Publish or update a question
    {
        ...
        inputSchema: z.object({
            id: z.string().describe("External unique question identifier for question management.\n" +
            ...
            type: z.string().describe("Type of the question.\n" +
                ...
                "Example:\n" +
                "type=numerical"),
            content: z.string().describe("The main question text that will be displayed to the test taker.\n" +
            ...
            question_format: z.string().describe("Controls question text rendering.\n" +
            ...
            answer: z.string().describe("The correct answer(s) for the question.\n" +
            ...
            image: z.string().describe("Attach an image to the question.\n" +
                "Supported formats: PNG, JPEG, WebP\n" +
                "Format: filename=data, where data is either a base64-encoded image (whole data string) or a URL"),
            answer_order: z.string().describe("Controls whether the sequence of multiple answers matters.\n" +
                ...
                "answer_order=+"),
            answer_label: z.string().describe("Text displayed in/above the input field during the test.\n" +
                ...
                "points=3"),
            answer_hide: z.string().describe("Controls whether correct answers are hidden on the results page.\n" +
                "- Plus sign (+) to indicate YES\n" +
                "- Blank field or minus sign (-) indicates NO (default)\n" +
                ...
                "answer_require=1\n" +
                "answer_hide=+"),
            answer_indefinite: z.string().describe("Allows users to add any number of input fields using + and - buttons.\n" +
                "- Plus sign (+) to indicate YES\n" +
                "- Blank field or minus sign (-) indicates NO (default)\n" +
                ...
                "answer_indefinite=+"),
            answer_format: z.string().describe("Defines how to display the answer on the results page.\n" +
                ...
                "answer_format=code:sql"),
            answer_require: z.string().describe("Number of answers required for maximum score.\n" +
            ...
            options: z.string().describe("Incorrect options or false statements for choice-based question types.\n" +
            ...
            points: z.string().describe("Maximum points for a fully correct answer.\n" +
                "- Default: 1 point\n" +
                "- For questions with multiple answers, partial credit is possible based on SUBSCORING method\n" +
                "Example:\n" +
                "points=10"),
            subscoring: z.string().describe("Method for calculating partial credit for partially correct answers.\n" +
                ...
                "subscoring=CUSTOM\n" +
                "subpoints=25 &&& 75"),
            subpoints: z.string().describe("Define specific point values for each answer in percentages.\n" +
            ...
            penalty_scoring: z.string().describe("Controls how penalty points should be applied.\n" +
                "- Available values:\n" +
            ...
            solution_penalty: z.string().describe("Similar to HINT_PENALTY\n" +
                "Point deduction for viewing steps of the solution (NONE, ONCE:N%) (default: NONE)"),
            solution_image: z.string().describe("Attach an image to the solution steps.\n" +
                "Supported formats: PNG, JPEG, WebP\n" +
                "Format: filename=data, where data is either a base64-encoded image (whole data string) or a URL"),
            video_penalty: z.string().describe("Similar to HINT_PENALTY\n" +
                "Point deduction for video assistance used (NONE, ONCE:N%) (default: NONE)"),
            manual_scoring: z.string().describe("Controls when to enable manual scoring.\n" +
            ...
            parameters: z.string().describe("Parameter definitions for dynamic question generation.\n" +
            ...
            parameters_sync: z.string().describe("Controls synchronization of LIST parameter selections.\n" +
                "- Plus sign (+) to indicate YES\n" +
                "- Blank field or minus sign (-) indicates NO (default)\n" +
            ...
            expression_check: z.string().describe("Define how expressions should be validated (RANDOM, EXPLICIT, COMPARE) (default: RANDOM).\n" +
            ...
            expression_functions: z.string().describe("Controls whether functions can be used in user inputs (+ for yes, - for no) (default: +).\n" +
            ...
            expression_random_type: z.string().describe("Type of generated test values (INTEGER, FLOAT).\n" +
            ...
            expression_random_tries: z.string().describe("Number of validation points (default: 5).\n" +
                "- Only applicable when expression_check=RANDOM\n" +
                "- Higher values increase validation reliability but impact performance\n" +
                "Example:\n" +
                "expression_random_tries=8"),
            expression_random_range: z.string().describe("Define value generation ranges (format: [min-max]).\n" +
                "- Specify per variable with &&&\n" +
                "- Only applicable when expression_check=RANDOM\n" +
                "Example:\n" +
                "expression_random_range=[8-16] &&& [4-6]  # Different ranges for different variables"),
            expression_random_inside: z.string().describe("Require values within specific intervals (format: [start-end]).\n" +
                "- Multiple intervals: separate with ||| (OR relationship)\n" +
                "- Specify per variable with &&&\n" +
                "- Only applicable when expression_check=RANDOM\n" +
                "Example:\n" +
                "expression_random_inside=[4-8] ||| [12-16] &&& [2-3]"),
            expression_random_outside: z.string().describe("Exclude values from specific intervals (format: [start-end]).\n" +
                "- Multiple intervals: separate with ||| (AND relationship)\n" +
                "- Specify per variable with &&&\n" +
                "- Only applicable when expression_check=RANDOM\n" +
                "Example:\n" +
                "expression_random_outside=[0-1] ||| [10-20] &&& [8-11]"),
            expression_explicit_goal: z.string().describe("Define exact value pairs (format: [x;f(x)]).\n" +
            ...
            expression_extended: z.string().describe("Enable additional mathematical functions (+ to enable, - to disable).\n" +
                "- Activates support for custom base logarithms (e.g., log2(4))\n" +
                "- Enables factorial operations (e.g., 5!, 1!+2!+3!)\n" +
                "Example:\n" +
                "expression_extended=+"),
            attachment: z.string().describe("Attach a file to the question.\n" +
                "Format: filename=data, where data is either a base64-encoded file (whole data string) or a URL"),
            media_audio: z.string().describe("Attach an audio file to the question.\n" +
            ...
            ai: z.string().describe("Flag to mark question as AI generated.\n" +
            ...
            decimals: z.string().describe("Decimal precision (default: 2).\n" +
                ...
                "Example:\n" +
                "decimals=3"),
            tolerance: z.string().describe("Evaluation tolerance method.\n" +
                "- Applicable only for NUMERIC / EXPRESSION / MATRIX / MATRIX:EXPRESSION / SET questions\n" +
            ...
            datetime_precision: z.string().describe("Date/time precision.\n" +
            ...
            datetime_range: z.string().describe("Date/time range (interval) question.\n" +
                "- Applicable only for DATE/TIME questions\n" +
                ...
                "Example:\n" +
                "datetime_range=+"),
            numerical_range: z.string().describe("Number range (interval) question.\n" +
                "- Only applicable for NUMERIC questions\n" +
                "- Plus sign (+) to indicate YES, while blank field or minus sign (-) indicates NO (default)\n" +
                "- Enables interval responses with the format {from}-{to}\n" +
                "Example:\n" +
                "numerical_range=+"),
            truefalse_third_options: z.string().describe("Activate the third option for TRUE/FALSE questions.\n" +
            ...
            truefalse_third_options_label: z.string().describe("Label of the third option for TRUE/FALSE questions.\n" +
            ...
            freetext_characters: z.string().describe("Limit the number of characters that can be entered.\n" +
            ...
            freetext_words: z.string().describe("Limit the number of words that can be entered.\n" +
                "- Applicable only for FREE-TEXT questions\n" +
                "- Format: minimum-maximum, but you can specify only a minimum or maximum as well\n" +
                "- Integer(s) between 0-4000\n" +
                "Example:\n" +
                "freetext_words=-50 # Max. 50 words"),
            freetext_rules: z.string().describe("Automatic evaluation of free text questions.\n" +
                "- Applicable only for FREE-TEXT questions\n" +
            ...
            file_count: z.string().describe("Limit the number of files that can be uploaded.\n" +
                "- Applicable only for FILE questions\n" +
                "- Integer between 1-25\n" +
                "Example:\n" +
                "file_count=1"),
            file_types: z.string().describe("Limit the filetypes that can be uploaded.\n" +
                "- Applicable only for FILE questions\n" +
                "- File extensions separated by triple-and operators (&&&)\n" +
                "Example:\n" +
                "file_types=zip &&& rar"),
            hotspot_image: z.string().describe("The image on which the points must be marked.\n" +
                "Supported formats: PNG, JPEG, WebP\n" +
                "Format: filename=data, where data is either a base64-encoded image (whole data string) or a URL"),
            hotspot_zones: z.string().describe("Zones accepted as answers.\n" +
            ...
            tags: z.string().describe("Tag questions with custom user-defined tags.\n" +
            ...
            labels: z.string().describe("Categorize questions with instance-level labels.\n" +
            ...
            group: z.string().describe("Add a question to a question group in a Quiz set.\n" +
