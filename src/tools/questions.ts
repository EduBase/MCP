...
export const EDUBASE_API_TOOLS_QUESTIONS = [
	...
	// POST /question - Publish or update a question
	{
		...
		inputSchema: z.object({
				...
				question_format: z.string().describe(
				...
				answer_order: z.string().describe(
				...
				answer_label: z.string().describe(
				...
				answer_indefinite: z.string().describe(
				...
				answer_format: z.string().describe(
				...
				answer_require: z.string().describe(
				...
				options_order: z.string().describe(
				...
				penalty_scoring: z.string().describe(
				...
				penalty_points: z.string().describe(
				...
				hint_penalty: z.string().describe(
				...
				parameters_sync: z.string().describe(
				...
				expression_check: z.string().describe(
				...
				expression_variable: z.string().describe(
				...
				expression_decimals: z.string().describe(
				...
				expression_functions: z.string().describe(
				...
				expression_random_type: z.string().describe(
				...
				expression_random_tries: z.string().describe(
				...
				expression_random_range: z.string().describe(
				...
				expression_random_inside: z.string().describe(
				...
				expression_random_outside: z.string().describe(
				...
				expression_explicit_goal: z.string().describe(
				...
				expression_extended: z.string().describe(
				...
				private_note: z.string().describe(
				...
				datetime_precision: z.string().describe(
						"Date/time precision.\n" +
				...
				datetime_range: z.string().describe(
				...
				numerical_range: z.string().describe(
				...
				truefalse_third_options: z.string().describe(
				...
				truefalse_third_options_label: z.string().describe(
				...
				freetext_characters: z.string().describe(
				...
				freetext_words: z.string().describe(
				...
				freetext_rules: z.string().describe(
				...
				hotspot_image: z.string().describe(
						"The image on which the points must be marked.\n" +
						"Supported formats: PNG, JPEG, WebP\n" +
						"Format: filename=data, where data is either a base64-encoded image (whole data string) or a URL"
				),
				hotspot_zones: z.string().describe(
				...
				main_category: z.string().describe(
